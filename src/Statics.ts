export class Statics {
  ...
  static readonly secretsSdJwtVcCert = '/yivi-brp-issue/container/sdjwtvc-cert';
  static readonly secretsSdJwtVcPrivateKey = '/yivi-brp-issue/container/sdjwtvc-private-key';
